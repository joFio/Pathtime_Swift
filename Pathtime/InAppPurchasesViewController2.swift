...
class InAppPurchasesViewController2: SKStoreProductViewController,SKStoreProductViewControllerDelegate{
...
//        self.alert = UIAlertController()
    ...
    func launchPurhcase(){
        print("test1")
        self.loadProduct(withParameters: [SKStoreProductParameterITunesItemIdentifier : NSNumber(value:1099277489)]) { (success:Bool, error:Error?) in
            print("test2")
            if success {
                print("Okay")}
            else {
